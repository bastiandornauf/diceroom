// MAIN DICE FUNCTIONS - Import only types, export only functions
// Clean architecture: Types -> Functions -> Export

import type { DiceResult, DiceRoll, DICE_EXAMPLES } from './dice-types';

// Re-export types and examples for convenience
export type { DiceResult, DiceRoll } from './dice-types';
export { DICE_EXAMPLES } from './dice-types';
